...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'aqm_art_homepage');
            }

            return array (  '_controller' => 'AQM\\ArtBundle\\Controller\\AcceuilController::indexAction',  '_route' => 'aqm_art_homepage',);
        }

        if (0 === strpos($pathinfo, '/admin')) {
            // aqm_art_admin_home
            if ('/admin' === $pathinfo) {
                return array (  '_controller' => 'AQM\\ArtBundle\\Controller\\AdminController::indexAction',  '_route' => 'aqm_art_admin_home',);
            }

            // aqm_art_admin_profil_edit
            if ('/admin/profil/edit' === $pathinfo) {
        ...
        if (0 === strpos($pathinfo, '/login')) {
            ...
            if ('/login' === $pathinfo) {
                ...
                return array (  '_controller' => 'AQM\\UserBundle\\Controller\\SecurityController::loginAction',  '_route' => 'fos_user_security_login',);
            }
            ...
            if ('/login_check' === $pathinfo) {
                ...
                return array (  '_controller' => 'AQM\\UserBundle\\Controller\\SecurityController::checkAction',  '_route' => 'fos_user_security_check',);
            }
        ...
        if ('/logout' === $pathinfo) {
            ...
            return array (  '_controller' => 'AQM\\UserBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'fos_user_security_logout',);
        }
