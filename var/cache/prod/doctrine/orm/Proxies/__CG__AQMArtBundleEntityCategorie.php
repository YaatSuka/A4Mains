...
namespace Proxies\__CG__\AQM\ArtBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Categorie extends \AQM\ArtBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AQM\\ArtBundle\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'AQM\\ArtBundle\\Entity\\Categorie' . "\0" . 'libelle', '' . "\0" . 'AQM\\ArtBundle\\Entity\\Categorie' . "\0" . 'ordre', '' . "\0" . 'AQM\\ArtBundle\\Entity\\Categorie' . "\0" . 'articles'];
        }
